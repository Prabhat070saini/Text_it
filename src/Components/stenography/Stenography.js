    ...
    return (
        <div className='bodys' >
            ...
            <header className='header'>
                <div className='back_btn_container '><NavLink to="/"><AiOutlineRollback className='back_btn' /></NavLink></div>
            ...
            <div >
                ...
                <div>
                    ...
                    <img id="encoded-image" alt='' width={450} height={450} className='imagedisplay imagedisplayshow' ></img>
